...
export default function Feeds() {
  ...
  return (
    <div className="flex flex-col gap-2 h-[1000px] w-[1200px] justify-center items-center  dark:bg-gray-950 z-0 dark:text-white ">
      ...
      <div className="centered-div  ">
        ...
        <div className="width-height mt-0 dark:bg-gray-950/70 dark:border dark:border-gray-700 ">
          {/* Hidden on mobile */}
          ...
          <hr className="hidden md:block border-t border-gray-300 dark:border-gray-700" />
